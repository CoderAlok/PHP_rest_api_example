            ...
            <tbody>
              ...
              <?php foreach($data['data'] as $key => $value) { ?>
                <tr>
                    ...
                    <td><a href="<?=site_url('catagories')?>" style="text-decoration: none;"><?=$value['Catagory']?></a></td>
                    <!-- <td><?=$value['type']?></td> -->
                    <td>
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <?php $cats = ['none', 'Fruits', 'Vegetables', 'Dairy']; foreach($cats as $key => $val) {?>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <?php $units = ['none', 'Kg', 'Mg', 'ltr']; foreach($units as $key) {?>
